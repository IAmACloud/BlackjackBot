...
class MovementNode:
    def __init__(self):
        ...
        # Publisher
        self.pub_complete = rospy.Publisher('/movement/complete', MovementComplete, queue_size=10)
        
        # Subscriber
        self.sub_control = rospy.Subscriber('/movement/control', MovementControl, self.control_callback, queue_size=5)
        
        # State
        self.current_command = None
    
    def control_callback(self, msg: MovementControl):
